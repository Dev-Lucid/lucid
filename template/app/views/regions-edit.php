...
$card->block()->add([
    html::formGroup(_('model:regions:country_id'), html::input('text', 'country_id', $data->country_id)),
    html::formGroup(_('model:regions:abbreviation'), html::input('text', 'abbreviation', $data->abbreviation)),
    html::formGroup(_('model:regions:name'), html::input('text', 'name', $data->name)),
    html::formGroup(_('model:regions:type'), html::input('text', 'type', $data->type)),
    html::formGroup(_('model:regions:parent'), html::input('text', 'parent', $data->parent)),
    html::formGroup(_('model:regions:is_parent'), html::input('checkbox', 'is_parent', $data->is_parent)),
