...
lucid::$mvc->controller('navigation')->render('view.dashboard', 'view.regions-table');
...
$table = html::dataTable(_('model:regions'), 'regions-table', lucid::$mvc->model('regions'), 'app.php?action=view.regions-table');
...
$table->add(html::dataColumn(_('model:regions:country_id'), 'country_id', '15%', true));
$table->add(html::dataColumn(_('model:regions:abbreviation'), 'abbreviation', '15%', true));
$table->add(html::dataColumn(_('model:regions:name'), 'name', '15%', true));
$table->add(html::dataColumn(_('model:regions:type'), 'type', '15%', true));
$table->add(html::dataColumn(_('model:regions:parent'), 'parent', '15%', true));
$table->add(html::dataColumn(_('model:regions:is_parent'), 'is_parent', '15%', true));
...
$table->enableAddNewButton('#!view.regions-edit|region_id|0', _('button:add_new'));
