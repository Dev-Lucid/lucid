...
lucid::controller('navigation')->render('view.dashboard', 'view.regions-table');
...
$table = html::dataTable(_('model:regions'), 'regions-table', lucid::model('regions'), 'app.php?action=view.regions-table');
