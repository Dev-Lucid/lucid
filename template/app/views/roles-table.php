...
lucid::controller('navigation')->render('view.dashboard', 'view.roles-table');
...
$table = html::dataTable(_('model:roles'), 'roles-table', lucid::model('roles'), 'app.php?action=view.roles-table');
