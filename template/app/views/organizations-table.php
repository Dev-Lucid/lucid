...
lucid::$mvc->controller('navigation')->render('view.organizations-table');
...
$table = html::dataTable(_('model:organizations'), 'organizations-table', lucid::$mvc->model('organizations'), 'app.php?action=view.organizations-table');
...
$table->add(html::dataColumn(_('model:organizations:role_id'), 'role_id', '23%', true));
$table->add(html::dataColumn(_('model:organizations:name'), 'name', '23%', true));
$table->add(html::dataColumn(_('model:organizations:is_enabled'), 'is_enabled', '23%', true));
$table->add(html::dataColumn(_('model:organizations:created_on'), 'created_on', '23%', true));
...
$table->enableAddNewButton('#!view.organizations-edit|org_id|0', _('button:add_new'));
