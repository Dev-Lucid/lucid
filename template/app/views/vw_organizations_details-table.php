...
$table = html::dataTable(_('model:vw_organizations_details'), 'vw_organizations_details-table', lucid::model('vw_organizations_details'), 'app.php?action=view.vw_organizations_details-table');
