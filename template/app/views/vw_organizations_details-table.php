...
lucid::$mvc->controller('navigation')->render('view.vw_organizations_details-table');
...
$table = html::dataTable(_('model:vw_organizations_details'), 'vw_organizations_details-table', lucid::$mvc->model('vw_organizations_details'), 'app.php?action=view.vw_organizations_details-table');
...
$table->add(html::dataColumn(_('model:vw_organizations_details:name'), 'name', '23%', true));
$table->add(html::dataColumn(_('model:vw_organizations_details:role_id'), 'role_id', '23%', true));
$table->add(html::dataColumn(_('model:vw_organizations_details:role_name'), 'role_name', '23%', true));
$table->add(html::dataColumn(_('model:vw_organizations_details:nbr_of_users'), 'nbr_of_users', '23%', true));
...
$table->enableSearchFilter(['name','role_id','role_name','nbr_of_users']);
...
$table->enableAddNewButton('#!view.vw_organizations_details-edit|org_id|0', _('button:add_new'));
