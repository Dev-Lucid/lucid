...
lucid::$mvc->controller('navigation')->render('view.dashboard', 'view.countries-table');
...
$table = html::dataTable(_('model:countries'), 'countries-table', lucid::$mvc->model('countries'), 'app.php?action=view.countries-table');
