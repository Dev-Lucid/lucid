...
/**
  ...
  */
class ControllerOrganizations extends Controller implements ControllerInterface
{
    /**
    ...
    public function ruleset(): Ruleset
    {
        return new Ruleset(__FILE__, __LINE__, [
            ...
            ['type'=>'validDate', 'label'=>_('model:organizations:created_on'), 'field'=>'created_on', ],
        ]);
    }
    ...
    public function save(int $org_id, int $role_id, string $name, bool $is_enabled, \DateTime $created_on, bool $do_redirect=true)
    {
        ...
        $data = lucid::$mvc->model('organizations', $org_id, false);
