...
class Vw_users_details extends \App\View
{
    public function table()
    {
        ...
        lucid::factory()->view('navigation')->render('vw_users_details.view.table');
        ...
        $table = html::dataTable(lucid::i18n()->translate('model:vw_users_details'), 'vw_users_details-table', $this->controller()->getList(), 'actions.php?action=vw_users_details.view.table');
        ...
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:email'), 'email', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:password'), 'password', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:first_name'), 'first_name', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:last_name'), 'last_name', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:org_id'), 'org_id', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:organization_name'), 'organization_name', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:role_id'), 'role_id', '12%', true));
        $table->add(html::dataColumn(lucid::i18n()->translate('model:vw_users_details:role_name'), 'role_name', '12%', true));


        # Add a column specifically for deleting rows.
        $table->add(html::dataColumn('', null, '10%', false, function($data){
            return html::button(lucid::i18n()->translate('button:delete'), 'danger', "if(confirm('".lucid::i18n()->translate('button:confirm_delete')."')){ lucid.request('#!vw_users_details.controller.delete|user_id|".$data->user_id."');}")->size('sm')->pull('right');
        }));
        ...
        $table->enableAddNewButton('#!vw_users_details.view.edit|user_id|0', lucid::i18n()->translate('button:add_new'));
    ...
    public function edit(string $user_id)
    {
        ...
        # Set the title tag for the page. Optionally, you can also set the description or keywords meta tag
        # by calling lucid::$response->description() or lucid::$response->keywords()
        lucid::response()->title(lucid::i18n()->translate('branding:app_name').' - Vw_users_details');

        # Render the navigation controller.
        lucid::factory()->view('navigation')->render('vw_users_details.view.table', 'vw_users_details.view.edit');
        ...
        $card->block()->add([
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:email'), html::input('text', 'email', $data->email)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:password'), html::input('text', 'password', $data->password)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:first_name'), html::input('text', 'first_name', $data->first_name)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:last_name'), html::input('text', 'last_name', $data->last_name)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:org_id'), html::input('text', 'org_id', $data->org_id)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:organization_name'), html::input('text', 'organization_name', $data->organization_name)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:role_id'), html::input('text', 'role_id', $data->role_id)),
            html::formGroup(lucid::i18n()->translate('model:vw_users_details:role_name'), html::input('text', 'role_name', $data->role_name)),
